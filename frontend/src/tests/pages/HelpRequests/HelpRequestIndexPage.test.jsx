...
describe("HelpRequestIndexPage tests", () => {
  ...
  test("renders three requests correctly for regular user", async () => {
    ...
    const createHelpRequestButtom = screen.queryByText("Create Help Requests");
    expect(createHelpRequestButtom).not.toBeInTheDocument();

    const requesterEmail = screen.getByText("dkim877@ucsb.edu");
    expect(requesterEmail).toBeInTheDocument();

    const teamId = screen.getByText("two");
