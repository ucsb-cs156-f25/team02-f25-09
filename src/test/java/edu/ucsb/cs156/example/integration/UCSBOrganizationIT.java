...
public class UCSBOrganizationIT {
  ...
  public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
    ...
    UCSBOrganization organization =
        UCSBOrganization.builder()
            .orgCode("K")
            .orgTranslationShort("Kappa")
            .orgTranslation("Kappa")
            .inactive(false)
            .build();
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/ucsborganization?orgCode=K"))
  ...
  public void an_admin_user_can_post_a_new_organization() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/ucsborganization/post?orgCode=A&orgTranslation=Alpha&orgTranslationShort=Alpha&inactive=false")
                    .with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
